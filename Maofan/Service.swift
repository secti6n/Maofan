...
class Service {
    ...
    func postText(parameters: [String: Any], success: Success?, failure: Failure?) {
        client.post(apiPath("/statuses/update"), parameters: parameters, success: success, failure: failure)
    }
    
    func postImage(parameters: [String: Any], image: Data, success: Success?, failure: Failure?) {
    ...
    func favorites_destroy(parameters: [String: Any], success: Success?, failure: Failure?) {
        guard let id = parameters["id"] else { return }
