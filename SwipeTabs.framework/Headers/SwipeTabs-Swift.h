...
SWIFT_CLASS("_TtC9SwipeTabs23SwipeTransitionAnimator")
@interface SwipeTransitionAnimator : NSObject <UIViewControllerAnimatedTransitioning>
- (nonnull instancetype)initWithTargetEdge:(UIRectEdge)edge OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9SwipeTabs23SwipeTransitionDelegate")
@interface SwipeTransitionDelegate : NSObject <UITabBarControllerDelegate>
@property (nonatomic, strong) IBOutlet UITabBarController * _Nullable tabBarController;
